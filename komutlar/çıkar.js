...
exports.run = async (client, mesaj, argumanlar) => {
  ...
  //Belirtilen kişinin bakiyesinden belirtilen miktarda azalt.
  db.subtract(`${mesaj.guild.id}_${kişi.id}_bakiye`, girilen);
  ...
  mesaj.channel.send(`${kişi} kullanıcısının bakiyesinden **${girilen}** çıkarıldı. (Şimdi **${db.get(`${mesaj.guild.id}_${kişi.id}_bakiye`)}**)`);
};
